...
function sanitizeFarm(f) {
  ...
  if (!Array.isArray(f.semenOrderBreeds)) f.semenOrderBreeds = [];
...
function dashboard() {
  ...
  /* [REBUILD FIX 143] professional realistic emblem icons (generated art +
     subtle CSS breathing micro-motion — no GIF/video). */
  const ARS_ICONS = {
    sow: `<img class="ars-ic-img" src="assets/ic-sow.jpg" alt="">`,
    preg: `<img class="ars-ic-img ars-d1" src="assets/ic-preg.jpg" alt="">`,
    lact: `<img class="ars-ic-img ars-d2" src="assets/ic-lact.jpg" alt="">`,
    boar: `<img class="ars-ic-img ars-d3" src="assets/ic-boar.jpg" alt="">`,
    piglets: `<img class="ars-ic-img ars-d4" src="assets/ic-piglets.jpg" alt="">`,
    feed: `<img class="ars-ic-img ars-d5" src="assets/ic-feed.jpg" alt="">`
  };
