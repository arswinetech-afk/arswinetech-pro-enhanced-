...
function dashboard() {
  ...
  /* [REBUILD FIX 142] custom animated swine icon set (SVG + CSS micro-motion) */
  const ARS_ICONS = {
    sow: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><path class="t" d="M13.5 27q-5.5-1-4.5-6.5" fill="none" stroke="#4fb3a9" stroke-width="2.4" stroke-linecap="round"/><g class="b"><ellipse cx="29" cy="29" rx="16" ry="10.5" fill="#8fd8d0"/><rect x="17.5" y="35" width="4.8" height="11" rx="2.4" fill="#4fb3a9"/><rect x="26.5" y="37" width="4.8" height="10" rx="2.4" fill="#4fb3a9"/><rect x="35" y="36" width="4.8" height="11" rx="2.4" fill="#4fb3a9"/></g><g class="h"><circle cx="45.5" cy="23" r="8.2" fill="#8fd8d0"/><ellipse cx="52.3" cy="25.5" rx="3.6" ry="2.7" fill="#4fb3a9"/><circle cx="44.5" cy="21" r="1.15" fill="#062a28"/></g><path class="e" d="M40.5 16.5l-3.2-6.2 5.8 1.9z" fill="#4fb3a9"/></svg>`,
    preg: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><path class="hb" d="M28 8.6c-1.9-2.7-5.9-1.4-5.9 1.6 0 2.5 3.4 4.6 5.9 6.3 2.5-1.7 5.9-3.8 5.9-6.3 0-3-4-4.3-5.9-1.6z" fill="#f7788f"/><path class="t" d="M12.5 28q-5.5-1-4.5-6.5" fill="none" stroke="#4fb3a9" stroke-width="2.4" stroke-linecap="round"/><g class="b"><ellipse cx="28.5" cy="30" rx="17" ry="12" fill="#8fd8d0"/><rect x="16.5" y="37" width="4.8" height="10" rx="2.4" fill="#4fb3a9"/><rect x="26" y="39" width="4.8" height="9" rx="2.4" fill="#4fb3a9"/><rect x="35" y="38" width="4.8" height="10" rx="2.4" fill="#4fb3a9"/></g><g class="h"><circle cx="46" cy="22.5" r="8" fill="#8fd8d0"/><ellipse cx="52.6" cy="25" rx="3.5" ry="2.6" fill="#4fb3a9"/><circle cx="45" cy="20.5" r="1.15" fill="#062a28"/></g><path class="e" d="M41 15.8l-3.1-6 5.7 1.8z" fill="#4fb3a9"/></svg>`,
    lact: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><g class="b"><ellipse cx="28" cy="33" rx="17.5" ry="9" fill="#8fd8d0"/><rect x="15" y="38" width="4.6" height="8" rx="2.3" fill="#4fb3a9"/><rect x="37" y="38" width="4.6" height="8" rx="2.3" fill="#4fb3a9"/></g><g class="h"><circle cx="46" cy="27" r="7.6" fill="#8fd8d0"/><ellipse cx="52.4" cy="29.5" rx="3.4" ry="2.5" fill="#4fb3a9"/><circle cx="45" cy="25" r="1.1" fill="#062a28"/></g><path class="e" d="M41.2 20.8l-3-5.8 5.5 1.8z" fill="#4fb3a9"/><g class="n1"><circle cx="22" cy="43.5" r="3.4" fill="#f7c3d6"/><ellipse cx="25" cy="44.5" rx="1.5" ry="1.1" fill="#e593b2"/></g><g class="n2"><circle cx="31" cy="44.5" r="3.2" fill="#f7c3d6"/><ellipse cx="33.9" cy="45.4" rx="1.4" ry="1" fill="#e593b2"/></g></svg>`,
    boar: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><path class="t" d="M12.5 26q-5.5-1-4.5-6.5" fill="none" stroke="#2b8d84" stroke-width="2.6" stroke-linecap="round"/><g class="b2"><ellipse cx="28" cy="28" rx="17" ry="11.5" fill="#6cc4bb"/><rect x="15.5" y="35" width="5.4" height="12" rx="2.6" fill="#2b8d84"/><rect x="25.5" y="37" width="5.4" height="11" rx="2.6" fill="#2b8d84"/><rect x="35" y="36" width="5.4" height="12" rx="2.6" fill="#2b8d84"/></g><g class="h"><circle cx="46" cy="21.5" r="9" fill="#6cc4bb"/><ellipse cx="53.4" cy="24.5" rx="3.9" ry="2.9" fill="#2b8d84"/><circle cx="44.6" cy="19" r="1.25" fill="#062a28"/><path d="M50.5 28.5q3.2-.8 4.4-3.2" fill="none" stroke="#eef8f7" stroke-width="1.7" stroke-linecap="round"/></g><path class="e" d="M40 13.5l-2.6-6.6 5.6 2.4z" fill="#2b8d84"/><path class="e" d="M47 12.5l1.6-6.4 3 5.6z" fill="#2b8d84"/></svg>`,
    piglets: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><g class="tr1"><ellipse cx="20" cy="36" rx="8" ry="5.4" fill="#a7e3dc"/><circle cx="27.5" cy="33.5" r="4" fill="#a7e3dc"/><ellipse cx="30.8" cy="34.8" rx="1.7" ry="1.2" fill="#4fb3a9"/><rect x="14.5" y="39.5" width="2.6" height="5.5" rx="1.3" fill="#4fb3a9"/><rect x="22.5" y="40" width="2.6" height="5" rx="1.3" fill="#4fb3a9"/><path d="M12.5 34.5q-3-.6-2.5-3.5" fill="none" stroke="#4fb3a9" stroke-width="1.5" stroke-linecap="round"/><circle cx="26.8" cy="32.5" r=".8" fill="#062a28"/></g><g class="tr2"><ellipse cx="42" cy="38" rx="7" ry="4.8" fill="#f7c3d6"/><circle cx="48.5" cy="35.8" r="3.6" fill="#f7c3d6"/><ellipse cx="51.4" ry="1.1" rx="1.5" cy="37" fill="#e593b2"/><rect x="37.5" y="41" width="2.4" height="5" rx="1.2" fill="#e593b2"/><rect x="44.5" y="41.5" width="2.4" height="4.6" rx="1.2" fill="#e593b2"/><path d="M35.5 36.8q-2.8-.5-2.3-3.2" fill="none" stroke="#e593b2" stroke-width="1.4" stroke-linecap="round"/><circle cx="47.9" cy="34.9" r=".75" fill="#4a1226"/></g></svg>`,
    feed: `<svg class="ars-ic" viewBox="0 0 64 52" aria-hidden="true"><path d="M20 16q-4 2-5 8l-2.5 16q-.5 5 4.5 5h22q5 0 4.5-5L41 24q-1-6-5-8z" fill="#e9c99a"/><path d="M20 16q6 3 16 0l-1.5-4.5q-6.5 2.5-13 0z" fill="#c98d4f"/><rect x="14" y="27" width="30" height="6" rx="3" fill="#c98d4f" opacity=".55"/><circle cx="24" cy="30" r="1.1" fill="#7a4d20" opacity=".6"/><circle cx="34" cy="30" r="1.1" fill="#7a4d20" opacity=".6"/><g class="g1"><ellipse cx="47" cy="40" rx="1.8" ry="2.4" fill="#ffd98a"/></g><g class="g2"><ellipse cx="51.5" cy="43" rx="1.6" ry="2.1" fill="#ffd98a"/></g><g class="g3"><ellipse cx="48.5" cy="46" rx="1.4" ry="1.9" fill="#f4b95c"/></g></svg>`
  };
    ...
    dashEl.innerHTML = `
      ...
      <div class="glance-grid">
        <div class="panel glance interactive-card" onclick="go('sows')" title="View all active sows">
          <span class="symbol">${ARS_ICONS.sow}</span><small>Total Sows</small><b>${activeSows.length}</b><small>Live farm count →</small>
        </div>
        <div class="panel glance interactive-card" onclick="go('sows')" title="View pregnant sows">
          <span class="symbol">${ARS_ICONS.preg}</span><small>Pregnant Sows</small><b>${pregnant.length}</b><small>In gestation cycle →</small>
        </div>
        <div class="panel glance interactive-card" onclick="go('sows')" title="View lactating sows">
          <span class="symbol">${ARS_ICONS.lact}</span><small>Lactating Sows</small><b>${lact.length}</b><small>Nursing litters →</small>
        </div>
        <div class="panel glance interactive-card" onclick="go('semen')" title="View registered boars">
          <span class="symbol">${ARS_ICONS.boar}</span><small>Active Boars</small><b>${boars}</b><small>Registered active boars →</small>
        </div>
      </div>
        ...
        <div>
          ...
          <div class="glance-grid" style="grid-template-columns:repeat(2,1fr)">
            <div class="panel glance interactive-card" onclick="go('piglets')" title="Open Piglet batches">
              <span class="symbol">${ARS_ICONS.piglets}</span><small>Piglets Alive</small><b>${totalPig}</b><small>Across ${pig.length} active batches →</small>
            </div>
        ...
        <div>
          ...
          <div class="glance-grid" style="grid-template-columns:repeat(2,1fr)">
            <div class="panel glance interactive-card" onclick="go('feed')" title="Open Feed Inventory">
              <span class="symbol">${ARS_ICONS.feed}</span><small>Feed Stock</small><b>${totalFeedBags} <small>bags</small></b><small>${peso(feedVal)} value →</small>
            </div>
